...
| [Flux 1.0](https://blackforestlabs.ai/flux) | Open diffusion model delivering SDXL-level fidelity with native ControlNet and depth conditioning support. | `open-source`, `text-to-image`, `controlnet`, `photoreal` | Apache-2.0 | Aug 2025 weights refresh announced on Black Forest Labs blog | Ship cinematic key art with fine control over lighting and composition; Fine-tune on internal datasets for typography-aware campaigns |
